...
export function OptionButton({text}) {
  ...
  return (
      ...
      <button
        onClick={openDialog}
        className="border-2 text-center flex justify-center items-center cursor-pointer text-[#6200ee] font-semibold border-[#6200ee] rounded-lg h-12 w-[200px] transition-all duration-300 ease-in-out"
      >
        {text}
      </button>
