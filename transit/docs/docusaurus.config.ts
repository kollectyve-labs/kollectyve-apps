...
const config: Config = {
  title: 'Kollectyve Network',
  tagline: 'Building leapfrog primitives, opening Africa to itself and to the world',
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Kollectyve Network. Built with Docusaurus.`,
    },
    prism: {
